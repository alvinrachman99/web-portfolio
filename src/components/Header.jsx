    ...
    <>
      <div id="Header" className="py-4 px-8 xl:px-32 flex flex-col md:pt-14 md:order-first">
        ...
        <div className="flex flex-col lg:flex-row py-1 gap-2">
          <button className="w-fit py-1 px-3 text-xs border-2 border-dashed border-sky-950 dark:border-white dark:hover:bg-gray-100 dark:hover:text-sky-950 rounded-md hover:bg-sky-950 hover:text-white">
            📱 +62 858 9244 2489
          </button>
          <button className="w-fit py-1 px-3 text-xs border-2 border-dashed border-sky-950 dark:border-white dark:hover:bg-gray-100 dark:hover:text-sky-950 rounded-md hover:bg-sky-950 hover:text-white">
